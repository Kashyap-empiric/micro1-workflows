...
- `head-to-head-07-23-template.md` under "Source: REUSABLE CONTEXT" holds the client's own Voice
  section and the per-dimension definitions. Re-read the per-dimension entry for each box before
  finalizing it.
